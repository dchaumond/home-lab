module "apps2_runner_ryzen" {
  source = "../../modules/lxc"

  node_name           = "pve-ryzen"
  vm_id               = local.secrets.apps2_runner_ryzen.ct_id
  hostname            = local.secrets.apps2_runner_ryzen.hostname
  ...
  disk_size         = local.secrets.apps2_runner_ryzen.disk_size

  memory_dedicated = local.secrets.apps2_runner_ryzen.memory

  ip_configs = [{
    ipv4 = {
      address  = local.secrets.apps2_runner_ryzen.ip
